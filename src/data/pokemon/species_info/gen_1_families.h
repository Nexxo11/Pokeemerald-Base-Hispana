...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                //{EVO_SPECIFIC_MAP, MAP_PETALBURG_WOODS, SPECIES_LEAFEON}, <- Evolucion por mapa especifico
                                {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                                //{EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_GLACEON}, <- Evolucion por mapa especifico
